...
def create_notebook(
    ...
    name: str | None = typer.Option(None, "--name", "-n", help="Notebook name"),
    private: bool = typer.Option(True, "--private/--public", help="Private or public"),
    output: OutputFormat | None = typer.Option(None, "-o", "--output"),
) -> None:
...
def create_slo(
    ...
    set_values: list[str] | None = typer.Option(None, "--set", help="Set template variables"),
    output: OutputFormat | None = typer.Option(None, "-o", "--output"),
) -> None:
...
def create_lookup_table(
    ...
    name: str | None = typer.Option(None, "--name", "-n", help="Table name (required for CSV)"),
    description: str | None = typer.Option(None, "--description", "-d", help="Table description"),
